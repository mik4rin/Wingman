...
public class PinnedNotesAdapter extends ListAdapter<Note, PinnedNotesAdapter.PinnedNoteViewHolder> {

    public interface OnPinnedNoteClickListener {
    ...
    @NonNull
    @Override
    public PinnedNoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.notes_card, parent, false);
        return new PinnedNoteViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull PinnedNoteViewHolder holder, int position) {
        holder.bind(getItem(position));
    }

    class PinnedNoteViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
